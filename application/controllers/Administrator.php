...
class Administrator extends CI_Controller {
    ...
    function konsumen(){
        ...
        $data['record'] = $this->model_app->view_ordering('penyewa','id_penyewa','DESC');
    ...
    function edit_konsumen(){
        ...
        if (isset($_POST['submit'])){
            ...
            $where = array('id_penyewa' => $this->input->post('id'));
            $this->model_app->update('penyewa', $data, $where);
    ...
    function delete_konsumen(){
        ...
        $this->model_app->delete('penyewa',$id);
        redirect('administrator/konsumen');
    }
    ...
    function reseller(){
        ...
        $data['record'] = $this->model_app->view_ordering('pemilik','id_pemilik','DESC');
    ...
    function delete_reseller(){
        cek_session_akses('reseller',$this->session->id_session);
        $id = array('id_pemilik' => $this->uri->segment(3));
        $this->model_app->delete('pemilik',$id);
        redirect('administrator/reseller');
    }
    ...
    function produk(){
        ...
        $data['record'] = $this->model_app->view_ordering('kost','id_kost','DESC');
    ...
    function edit_produk(){
        ...
        if (isset($_POST['submit'])){
            ...
            $where = array('id_kost' => $this->input->post('id'));
            $this->model_app->update('kost', $data, $where);
            redirect('administrator/produk');
        }else{
            $data['record'] = $this->model_app->view_ordering('rb_kategori_produk','id_kategori_produk','DESC');
            $data['rows'] = $this->model_app->edit('kost',array('id_kost'=>$id))->row_array();
    ...
    function detail_pembelian(){
        ...
        $data['record'] = $this->model_app->view_join_where('rb_pembelian_detail','kost','id_kost',array('id_pembelian'=>$this->uri->segment(3)),'id_pembelian_detail','DESC');
    ...
    function tambah_pembelian(){
        ...
        if (isset($_POST['submit1'])){
            ...
            $data['record'] = $this->model_app->view_join_where('rb_pembelian_detail','kost','id_kost',array('id_pembelian'=>$this->session->idp),'id_pembelian_detail','DESC');
    ...
    function proses_penjualan(){
        cek_session_akses('penjualan',$this->session->id_session);
            ...
            foreach ($order->result_array() as $row) {
                $cek_produk = $this->db->query("SELECT * FROM kost where id_produk_perusahaan='$row[id_kost]' AND id_pemilik='$row[id_pembeli]'");
                if ($cek_produk->num_rows()>=1){
                    ...
                    $p = $this->db->query("SELECT * FROM kost where id_kostk='$row[id_kost]'")->row_array();
                    $data = array('id_produk_perusahaan'=>$p['id_kost'],
                                  'id_kategori_produk'=>$p['id_kategori_produk'],
                                  'id_kategori_produk_sub'=>$p['id_kategori_produk_sub'],
                                  'id_pemilik'=>$row['id_pembeli'],
    ...
    function bayar_bonus(){
        cek_session_akses('keuangan',$this->session->id_session);
        if (isset($_POST['submit'])){
            $data = array('id_pemilik'=>$this->input->post('idk'),
    ...
    function bayar_reward(){
        cek_session_akses('keuangan',$this->session->id_session);
        $data = array('id_pemilik'=>$this->uri->segment(3),
    ...
    function batalkan_reward(){
        cek_session_akses('keuangan',$this->session->id_session);
        $id = array('id_penyewa' => $this->uri->segment(4),'id_reward' => $this->uri->segment(3));
    ...
    function history_reward(){
        cek_session_akses('keuangan',$this->session->id_session);
        $data['record'] = $this->db->query("SELECT a.*, b.nama_pemilik, c.posisi, c.reward FROM `rb_pencairan_reward` a JOIN pemilik b ON a.id_pemilik=b.id_pemilik JOIN rb_reward c ON a.id_reward=c.id_reward ORDER BY a.id_pencairan_reward DESC");
    ...
    function history_referral(){
        cek_session_akses('keuangan',$this->session->id_session);
        $data['record'] = $this->db->query("SELECT a.*, b.nama_pemilik FROM `rb_pencairan_bonus` a JOIN pemilik b ON a.id_pemilik=b.id_pemilik ORDER BY a.id_pencairan_bonus DESC");
...
function testimoni(){
    ...
    $data['record'] = $this->db->query("SELECT a.*, b.nama_lengkap, b.username, b.id_penyewa FROM testimoni a JOIN penyewa b ON a.id_penyewa=b.id_penyewa ORDER BY a.id_testimoni DESC");
...
function edit_testimoni(){
    ...
    if (isset($_POST['submit'])){
        ...
        $data['rows'] = $this->db->query("SELECT a.*, b.nama_lengkap, b.username, b.id_penyewa FROM testimoni a LEFT JOIN penyewa b ON a.id_penyewa=b.id_penyewa where a.id_testimoni='$id'")->row_array();
