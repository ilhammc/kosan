    ...
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Kost Terpilih</h3>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form','name'=>'demo');
              echo form_open_multipart('reseller/edit_produk',$attributes);
              $disk = $this->model_app->edit('kost_diskon',array('id_kost'=>$rows['id_kost'],'id_pemilik'=>$this->session->id_pemilik))->row_array();
              $jual = $this->model_reseller->jual_reseller($this->session->id_pemilik,$rows['id_kost'])->row_array();
              $beli = $this->model_reseller->beli_reseller($this->session->id_pemilik,$rows['id_kost'])->row_array();
          echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value='$rows[id_kost]'>
                    ...
                    echo "</select></td></tr>
                    <tr><th width='130px' scope='row'>Nama Kost</th>  <td><input type='text' class='form-control' name='b' value='$rows[nama_kost]' required></td></tr>
                    <tr><th scope='row'>Satuan</th>                     <td><input type='text' class='form-control' name='c' value='$rows[satuan]'></td></tr>
                    <tr><th scope='row'>Luas</th>                      <td><input type='number' class='form-control' name='berat' value='$rows[berat]'></td></tr>
                    ...
                    <tr><th scope='row'>Foto Kost</th>                     <td><input type='file' id='fileupload' class='form-control' name='userfile[]' multiple>Multiple Upload, Allowed File : .gif, jpg, png
