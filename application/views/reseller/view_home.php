...
?>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Total Sewa</span>
            ...
            <section class="col-lg-5 connectedSortable">
              ...
              <div class="box box-info">
                ...
                <h3 class="box-title">Selamat datang Pemilik!</h3>
                  ...
                  Silahkan mengelola Semua data melalui menu yang sudah kita sediakan dibelah kiri anda, berikut data profile anda : <br><br>
                      ...
                      $rows = $this->model_app->edit('pemilik',array('id_pemilik'=>$this->session->id_pemilik))->row_array();
                    ...
                    <hr style='margin:7px'>
                    <a class='btn btn-default btn-block' href="<?php echo base_url().$this->uri->segment(1); ?>/edit_reseller/<?php echo $this->session->id_pemilik; ?>">Edit Profile</a>
                    <a target='_BLANK' class='btn btn-success btn-block' href="<?php echo base_url(); ?>produk/produk_reseller/<?php echo $this->session->id_pemilik; ?>">Lihat Lapak anda!</a>
                    <br><br>
                  </div>
              </div>
            ...
            <section class="col-lg-7 connectedSortable">
              ...
              <div class="box-body">
                <table class="table table-bordered table-striped table-condensed">
                  ...
                  <?php
                    $no = 1;
                    $record = $this->model_reseller->penjualan_list_konsumen_top($this->session->id_pemilik,'reseller');
