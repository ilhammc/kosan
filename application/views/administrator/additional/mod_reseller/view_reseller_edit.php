    ...
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Data Pemilik</h3>
                </div>
              <div class='box-body'>";
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    <input type='hidden'  value='$rows[id_pemilik]' name='id'>";
                    ...
                    <tr><th scope='row'>Nama Reseller</th>                <td><input class='form-control' type='text' name='c' value='$rows[nama_pemilik]'></td></tr>
