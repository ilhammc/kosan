              ...
              <div class="box">
                ...
                ?>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Nama Reseller</th>                 <td><select class='form-control' name='b'>
                                                                                <option value='' selected></option>
                                                                                <?php
                                                                                  foreach ($reseller as $r){
                                                                                    if ($r['id_pemilik']==$rows['id_pemilik']){
                                                                                      echo "<option value='$r[id_pemilik]' selected>$r[nama_pemilik]</option>";
                                                                                    }else{
                                ...
                                <td><select name='aa' class='combobox form-control' onchange=\"changeValue(this.value)\" autofocus>
                                                                      ...
                                                                      foreach ($barang as $r){
                                                                        if ($r['id_kost']==$row['id_kost']){
                                                                          ...
                                                                          $jsArray .= "prdName['" . $r['id_kost'] . "'] = {name:'" . addslashes($r['harga_reseller']) . "',desc:'".addslashes($r['satuan'])."'};\n";
                                                                        }else{
