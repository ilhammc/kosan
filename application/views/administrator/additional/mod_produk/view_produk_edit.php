...
<?php
    echo "<div class='col-md-12'>
              ...
              $disk = $this->model_app->edit('kost_diskon',array('id_kost'=>$rows['id_kost']))->row_array();
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    echo "</select></td></tr>
                    <tr><th width='130px' scope='row'>Nama Produk</th>  <td><input type='text' class='form-control' name='b' value='$rows[nama_kost]' required></td></tr>
