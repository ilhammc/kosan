  <p class='sidebar-title text-danger produk-title'> Login Penyewa</p>

            <div class='alert alert-info'>Masukkan Username dan Password Anda</div>
            <br>
            <?php
            ...
            <div class="logincontainer">
                <form method="post" action="<?php echo base_url(); ?>auth/login" role="form" id='formku'>
                    ...
                    <center><a href='<?php echo base_url(); ?>reseller'>Login Pemilik</a><center>
                </form>
            </div>
