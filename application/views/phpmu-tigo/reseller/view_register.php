<div class='panel-body'>
    <ul class='myTabs nav nav-tabs' role='tablist'>
      <li role='presentation' class='active'><a href='#konsumen' id='konsumen-tab' role='tab' data-toggle='tab' aria-controls='konsumen' aria-expanded='true'>Pendaftaran Penyewa </a></li>
      <li role='presentation' class=''><a href='#reseller' role='tab' id='reseller-tab' data-toggle='tab' aria-controls='reseller' aria-expanded='false'>Pendaftaran Pemilik</a></li>
    </ul><br>
    <div id='myTabContent' class='tab-content'>
        <div role='tabpanel' class='tab-pane fade active in' id='konsumen' aria-labelledby='konsumen-tab'>

            <div class='alert alert-info'><b>PENTING!</b> Lengkapi Form dibawah ini untuk mendaftarkan diri Sebagai <b>Penyewa</b>, harap di isi dengan data yang sebenar-benarnya sesuai dengan KTP, Terima kasih...</div>
            <div class="block-content">
                <div id="writecomment">
                    <form action="<?php echo base_url(); ?>auth/register" method="POST" id="form_komentar">
                        ...
                        <p><input type="submit" name="submit1" class="styled-button" value="Daftar Sebagai Penyewa"/></p>
                    </form>
                </div>
            </div>
        ...
        <div class='alert alert-warning'><b>PENTING!</b> Lengkapi Form dibawah ini untuk mendaftarkan diri sebagai <b>Pemilik</b>, harap di isi dengan data yang sebenar-benarnya, Terima kasih...</div>
            <div class="block-content">
                <div id="writecomment">
                    <form action="<?php echo base_url(); ?>auth/register" method="POST" id="form_komentar">
                        <p class="contact-form-user">
                        ...
                        <p class="contact-form-user">
                            <label for="c_name">Nama Kost<span class="required">*</label>
                        ...
                        <p><input type="submit" name="submit2" class="styled-button" value="Daftar Sebagai Pemilik"/></p>
                    </form>
                </div>
            </div>
            <div style='clear:both'><br></div>
