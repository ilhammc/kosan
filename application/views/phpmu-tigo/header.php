...
echo "<div class='wrapper'>
	...
	<div class='mainmenu hidden-xs'>
	    <ul class='mainnav'>
	        <li class='hassubs first'><a href='#'><span class='glyphicon glyphicon-th-list'></span>&nbsp;  </a>
	...
	<div class='header-menu'>
		<div class='header-search'>
			".form_open('produk/index')."
				<input type='text' placeholder='cari kost..'' name='kata' class='search-input' required/>
	...
	<div class='header-addons'>
		<span class='city'>
		  ...
		  if ($this->session->id_penyewa != ''){
		      $ksm = $this->db->query("SELECT * FROM penyewa where id_penyewa='".$this->session->id_penyewa."'")->row_array();
		  }
