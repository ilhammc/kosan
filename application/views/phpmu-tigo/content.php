...
foreach ($kategori->result_array() as $kat) {
	$produk = $this->model_reseller->produk_perkategori(0,0,$kat['id_kategori_produk'],6);
	    ...
	    $disk = $this->model_app->view_where("kost_diskon",array('id_kost'=>$row['id_kost']))->row_array();
	    ...
	    echo "<div class='produk col-md-2 col-xs-6'>
	              <center>
	                ...
	                <div style='height:140px; overflow:hidden'>
	                  <a title='$row[nama_kost]' href='".base_url()."produk/detail/$row[produk_seo]'><img style=' min-height:140px; width:100%' src='".base_url()."asset/foto_produk/$foto_produk'></a>
	                  		$diskon_persen
	                </div>
	                <h4 class='produk-title'><a title='$row[nama_kost]' href='".base_url()."produk/detail/$row[produk_seo]'>$judul</a></h4>
